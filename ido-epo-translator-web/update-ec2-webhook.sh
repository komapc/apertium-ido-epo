...
# Run this on EC2: curl -sL https://raw.githubusercontent.com/komapc/ido-epo-translator-web/main/update-ec2-webhook.sh | bash
...
curl -sL https://raw.githubusercontent.com/komapc/ido-epo-translator-web/main/webhook-server.js -o webhook-server.js.new
