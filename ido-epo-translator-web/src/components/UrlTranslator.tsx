        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 shadow-xl">
            ...
            <div className="p-4 bg-white/5 border border-white/20 rounded-lg max-h-96 overflow-y-auto">
              <p className="text-white whitespace-pre-line">{originalText}</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 shadow-xl">
            ...
            <div className="p-4 bg-white/5 border border-white/20 rounded-lg max-h-96 overflow-y-auto whitespace-pre-line font-mono">
